...
p;9;CPArray.jt;32161;@STATIC;1.0;i;14;CPEnumerator.ji;13;CPException.ji;10;CPObject.ji;9;CPRange.ji;18;CPSortDescriptor.jt;32053;objj_executeFile("CPEnumerator.j", YES);
...
{ with(self)
{
    ...
    if (count)
    {
        index = objj_msgSend(self, "_indexOfObject:sortedByFunction:context:", anObject, function(lhs, rhs)
        {
            var i = 0,
                result = CPOrderedSame;
            while (i < count)
...
p;8;CPDate.jt;7511;@STATIC;1.0;i;10;CPObject.ji;10;CPString.jt;7462;objj_executeFile("CPObject.j", YES);
objj_executeFile("CPString.j", YES);
...
p;11;CPDecimal.jt;28284;@STATIC;1.0;i;9;CPArray.ji;10;CPNumber.jt;28236;objj_executeFile("CPArray.j", YES);
...
CPDecimalMakeWithString= function(string, locale)
{
    ...
    for (; i < (intpart?intpart.length:0); i++)
    {
        if (i >= CPDecimalMaxDigits)
            break;
        objj_msgSend(m, "addObject:", parseInt(intpart.charAt(i)));
    }
    var j = 0;
    for (; j < (decpart?decpart.length:0); j++)
    {
        if ((i + j) >= CPDecimalMaxDigits)
            break;
        objj_msgSend(m, "addObject:", parseInt(decpart.charAt(j)));
    }
...
p;17;CPDecimalNumber.jt;28901;@STATIC;1.0;i;10;CPObject.ji;11;CPDecimal.ji;13;CPException.jt;28832;objj_executeFile("CPObject.j", YES);
...
p;14;CPDictionary.jt;12635;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;13;CPException.ji;10;CPObject.jt;12550;objj_executeFile("CPArray.j", YES);
...
p;13;CPException.jt;5476;@STATIC;1.0;i;9;CPCoder.ji;10;CPObject.ji;10;CPString.jt;5414;objj_executeFile("CPCoder.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPString.j", YES);
...
p;13;CPIndexPath.jt;4870;@STATIC;1.0;i;10;CPObject.ji;9;CPArray.ji;9;CPRange.ji;18;CPSortDescriptor.ji;13;CPException.jt;4769;
...
p;19;CPKeyedUnarchiver.jt;14700;@STATIC;1.0;i;9;CPArray.ji;8;CPData.ji;14;CPDictionary.ji;9;CPCoder.ji;17;CPKeyedArchiver.ji;8;CPNull.ji;10;CPNumber.ji;10;CPString.jt;14559;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPData.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPCoder.j", YES);
...
p;18;CPKeyValueCoding.jt;9997;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;8;CPNull.ji;10;CPObject.ji;21;CPKeyValueObserving.jt;9893;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPNull.j", YES);
objj_executeFile("CPObject.j", YES);
...
var _modifierForKey = function(theClass, aKey)
{
    ...
    var UID = objj_msgSend(theClass, "UID"),
        selector = nil,
    ...
    var capitalizedKey = aKey.charAt(0).toUpperCase() + aKey.substr(1) + ':';
    if (objj_msgSend(theClass, "instancesRespondToSelector:", selector = CPSelectorFromString("set" + capitalizedKey)) ||
        objj_msgSend(theClass, "instancesRespondToSelector:", selector = CPSelectorFromString("_set" + capitalizedKey)))
    {
        objj_msgSend(modifiers, "setObject:forKey:", selector, aKey);
        return selector;
    }
    objj_msgSend(modifiers, "setObject:forKey:", Null, aKey);
    return nil;
}
...
p;21;CPKeyValueObserving.jt;39389;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;8;CPNull.ji;10;CPObject.ji;7;CPSet.ji;13;CPArray+KVO.ji;11;CPSet+KVO.jt;39247;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPNull.j", YES);
objj_executeFile("CPObject.j", YES);
...
},["void","CPKeyValueChange","CPIndexSet","CPString"]), new objj_method(sel_getUid("willChangeValueForKey:withSetMutation:usingObjects:"), function $CPObject__willChangeValueForKey_withSetMutation_usingObjects_(self, _cmd, key, mutationKind, objects)
{ with(self)
{
}
},["void","CPString","CPKeyValueSetMutationKind","CPSet"]), new objj_method(sel_getUid("didChangeValueForKey:withSetMutation:usingObjects:"), function $CPObject__didChangeValueForKey_withSetMutation_usingObjects_(self, _cmd, key, mutationKind, objects)
{ with(self)
{
}
...
{ with(self)
{
    var changeKind = objj_msgSend(aChange, "objectForKey:", CPKeyValueChangeKindKey),
        ...
        indexes = objj_msgSend(aChange, "objectForKey:", CPKeyValueChangeIndexesKey);
    if (newValue === objj_msgSend(CPNull, "null"))
        newValue = nil;
    if (changeKind === CPKeyValueChangeSetting)
    {
        objj_msgSend(self, "setValue:forKeyPath:", newValue, aKeyPath);
        return;
    }
    if (objj_msgSend(newValue, "isKindOfClass:",  objj_msgSend(CPSet, "class")) || objj_msgSend(oldValue, "isKindOfClass:",  objj_msgSend(CPSet, "class")))
    {
...
var _kvoInsertManyMethodForMethod = _kvoInsertManyMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, objects, indexes)
    {
        objj_msgSend(self, "willChange:valuesAtIndexes:forKey:", CPKeyValueChangeInsertion, indexes, theKey);
        theMethod.method_imp(self, _cmd, objects, indexes);
        objj_msgSend(self, "didChange:valuesAtIndexes:forKey:", CPKeyValueChangeInsertion, indexes, theKey);
    }
}
...
var _kvoReplaceManyMethodForMethod = _kvoReplaceManyMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, indexes, objects)
    {
        objj_msgSend(self, "willChange:valuesAtIndexes:forKey:", CPKeyValueChangeReplacement, indexes, theKey);
        theMethod.method_imp(self, _cmd, indexes, objects);
        objj_msgSend(self, "didChange:valuesAtIndexes:forKey:", CPKeyValueChangeReplacement, indexes, theKey);
    }
}
...
var _kvoRemoveManyMethodForMethod = _kvoRemoveManyMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, indexes)
    {
        objj_msgSend(self, "willChange:valuesAtIndexes:forKey:", CPKeyValueChangeRemoval, indexes, theKey);
        theMethod.method_imp(self, _cmd, indexes);
        objj_msgSend(self, "didChange:valuesAtIndexes:forKey:", CPKeyValueChangeRemoval, indexes, theKey);
    }
}
var _kvoUnionMethodForMethod = _kvoUnionMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, object)
    {
        objj_msgSend(self, "willChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueUnionSetMutation,  objj_msgSend(CPSet, "setWithObject:",  object));
        theMethod.method_imp(self, _cmd, object);
        objj_msgSend(self, "didChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueUnionSetMutation,  objj_msgSend(CPSet, "setWithObject:",  object));
    }
}
var _kvoUnionManyMethodForMethod = _kvoUnionManyMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, objects)
    {
        objj_msgSend(self, "willChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueUnionSetMutation,  objects);
        theMethod.method_imp(self, _cmd, objects);
        objj_msgSend(self, "didChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueUnionSetMutation,  objects);
    }
}
var _kvoMinusMethodForMethod = _kvoMinusMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, object)
    {
        objj_msgSend(self, "willChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueMinusSetMutation,  objj_msgSend(CPSet, "setWithObject:",  object));
        theMethod.method_imp(self, _cmd, object);
        objj_msgSend(self, "didChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueMinusSetMutation,  objj_msgSend(CPSet, "setWithObject:",  object));
    }
}
var _kvoMinusManyMethodForMethod = _kvoMinusManyMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, objects)
    {
        objj_msgSend(self, "willChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueMinusSetMutation,  objects);
        theMethod.method_imp(self, _cmd, objects);
        objj_msgSend(self, "didChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueMinusSetMutation,  objects);
    }
}
var _kvoIntersectManyMethodForMethod = _kvoIntersectManyMethodForMethod= function(theKey, theMethod)
{
    return function(self, _cmd, objects)
    {
        objj_msgSend(self, "willChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueIntersectSetMutation,  objects);
        theMethod.method_imp(self, _cmd, objects);
        objj_msgSend(self, "didChangeValueForKey:withSetMutation:usingObjects:", theKey, CPKeyValueIntersectSetMutation,  objects);
    }
}
...
p;11;CPScanner.jt;11466;@STATIC;1.0;I;27;Foundation/CPCharacterSet.jt;11414;objj_executeFile("Foundation/CPCharacterSet.j", NO);
...
p;11;CPSet+KVO.jt;19295;@STATIC;1.0;i;7;CPSet.jt;19264;objj_executeFile("CPSet.j", YES);
{
var the_class = objj_getClass("CPObject")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPObject\"");
...
{ with(self)
{
    ...
    {
        var object, objectEnumerator = objj_msgSend(objects, "objectEnumerator");
...
{ with(self)
{
    ...
    {
        var object, objectEnumerator = objj_msgSend(aSet, "objectEnumerator");
        while(object = objj_msgSend(objectEnumerator, "nextObject"))
            _add(_proxyObject, _addSEL, object);
    }
    else
...
{ with(self)
{
    ...
    {
        var object, objectEnumerator = objj_msgSend(objj_msgSend(objj_msgSend(self, "_representedObject"), "copy"), "objectEnumerator");
        while(object = objj_msgSend(objectEnumerator, "nextObject"))
            _remove(_proxyObject, _removeSEL, object);
    }
    else
...
{ with(self)
{
    ...
    {
        if (aKey.indexOf(".") !== -1)
            objj_msgSend(CPException, "raise:reason:", CPInvalidArgumentException, "called valueForKey: on a set with a complex key ("+aKey+"). use valueForKeyPath:");
        if (aKey == "@count")
            return objj_msgSend(self, "count");
        return nil;
    }
    else
    {
        ...
        var containedObject, containedObjectValue, containedObjectEnumerator = objj_msgSend(self, "objectEnumerator");
        while(containedObject = objj_msgSend(containedObjectEnumerator, "nextObject"))
        {
            containedObjectValue = objj_msgSend(containedObject, "valueForKey:", aKey);
...
},["id","CPString"]), new objj_method(sel_getUid("valueForKeyPath:"), function $CPSet__valueForKeyPath_(self, _cmd, aKeyPath)
{ with(self)
{
    if (aKeyPath.indexOf("@") === 0)
    {
...
{ with(self)
{
    var containedObject, containedObjectEnumerator = objj_msgSend(self, "objectEnumerator");
    while (containedObject = objj_msgSend(containedObjectEnumerator, "nextObject"))
        objj_msgSend(containedObject, "setValue:forKey:", aValue, aKey);
}
},["void","id","CPString"]), new objj_method(sel_getUid("setValue:forKeyPath:"), function $CPSet__setValue_forKeyPath_(self, _cmd, aValue, aKeyPath)
{ with(self)
{
    var containedObject, containedObjectEnumerator = objj_msgSend(self, "objectEnumerator");
    while (containedObject = objj_msgSend(containedObjectEnumerator, "nextObject"))
        objj_msgSend(containedObject, "setValue:forKeyPath:", aValue, aKeyPath);
}
},["void","id","CPString"])]);
}
var kvoOperators = [];
...
p;7;CPSet.jt;11722;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;10;CPNumber.ji;10;CPObject.jt;11640;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPEnumerator.j", YES);
objj_executeFile("CPNumber.j", YES);
objj_executeFile("CPObject.j", YES);
...
p;10;CPString.jt;17698;@STATIC;1.0;i;13;CPException.ji;10;CPObject.ji;18;CPSortDescriptor.ji;9;CPValue.jt;17609;objj_executeFile("CPException.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPSortDescriptor.j", YES);
objj_executeFile("CPValue.j", YES);
...
p;7;CPURL.jt;8626;@STATIC;1.0;i;10;CPObject.jt;8592;objj_executeFile("CPObject.j", YES);
