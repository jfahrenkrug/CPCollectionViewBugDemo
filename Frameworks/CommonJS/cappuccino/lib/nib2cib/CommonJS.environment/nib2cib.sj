...
p;16;NSNibConnector.jt;4098;@STATIC;1.0;I;23;AppKit/CPCibConnector.jI;30;AppKit/CPCibControlConnector.jI;29;AppKit/CPCibOutletConnector.jt;3982;
...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("NS_initWithCoder:"),function(_17,_18,_19){
with(_17){
if(_17=objj_msgSendSuper({receiver:_17,super_class:objj_getClass("CPCibBindingConnector").super_class},"NS_initWithCoder:",_19)){
_binding=objj_msgSend(_19,"decodeObjectForKey:","NSBinding");
_keyPath=objj_msgSend(_19,"decodeObjectForKey:","NSKeyPath");
_options=objj_msgSend(CPDictionary,"dictionary");
var _1a=objj_msgSend(_19,"decodeObjectForKey:","NSOptions"),_1b=objj_msgSend(_1a,"keyEnumerator"),_1c;
while(_1c=objj_msgSend(_1b,"nextObject")){
var _1d="CP"+_1c.substring(2);
objj_msgSend(_options,"setObject:forKey:",objj_msgSend(_1a,"objectForKey:",_1c),_1d);
}
...
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("initWithCoder:"),function(_1e,_1f,_20){
with(_1e){
return objj_msgSend(_1e,"NS_initWithCoder:",_20);
}
}),new objj_method(sel_getUid("classForKeyedArchiver"),function(_21,_22){
with(_21){
